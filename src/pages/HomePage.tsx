  ...
  return (
    <div>
      ...
      <section className="min-h-screen bg-navy-dark flex items-center relative overflow-hidden pt-[72px]">
        ...
        <div
          className="absolute -right-[100px] -top-[100px] w-[700px] h-[700px] rounded-full"
        ...
        <div className="relative z-[2] max-w-[1200px] mx-auto px-[60px] py-20 grid grid-cols-2 gap-[60px] items-center w-full max-md:grid-cols-1 max-md:px-6 max-md:text-center">
          <div>
            ...
            <h1
              className="font-bebas text-white leading-[0.95] tracking-[1px] mb-7"
              style={{ fontSize: "clamp(52px, 7vw, 86px)" }}
              dangerouslySetInnerHTML={{
                __html:
                  content?.hero_title ||
                  'Every Athlete<br />Needs Fuel.<span class="text-red block">Every Kid<br />Deserves It.</span>',
              }}
            />
            ...
            <div className="pt-11 border-t border-white/10 mt-11">
              <div
                className="font-bebas text-red leading-[0.85] tracking-[-1px]"
          ...
          <div className="flex flex-col justify-center items-center max-md:hidden -mt-16">
      ...
      <section className="bg-navy py-[100px] relative overflow-hidden">
        <div className="absolute -right-10 top-1/2 -translate-y-1/2 font-bebas text-[380px] text-white/[0.025] tracking-[-20px] leading-none pointer-events-none">
          FTF
        </div>
        <div className="max-w-[1200px] mx-auto px-[60px] max-md:px-6">
          <FadeUp>
            <div
              className="font-oswald text-[11px] tracking-[4px] uppercase font-medium mb-[14px] flex items-center gap-3"
          ...
          <FadeUp>
            <div className="grid grid-cols-3 gap-[3px] mt-[60px] max-md:grid-cols-1">
              {[
                {
                  bg: "bg-navy-mid",
                  letter: "F",
                  title: "Focus",
                  body: "Know where you're going. We help athletes and organizations direct their energy toward what matters most — eliminating distraction and building clarity of purpose.",
                },
                {
                  bg: "bg-red",
                  letter: "T",
                  title: "Trust",
                  body: "Believe in the process. High-performing teams are built on trust — in each other, in the system, and in the mission. With it, teams execute when it matters most.",
                },
                {
                  bg: "bg-[#1a5c2a]",
                  letter: "F",
                  title: "Finish",
                  body: "Execute. Every time. The world rewards finishers — not starters. We develop people who complete what they commit to, on the field and beyond it.",
                },
              ].map((card) => (
                <div key={card.title} className={`${card.bg} p-[56px_44px] relative overflow-hidden max-md:p-8`}>
                  <div className="font-bebas text-[110px] leading-[0.85] text-white/[0.12] absolute top-5 right-5">
                    {card.letter}
                  </div>
                  <h3 className="font-bebas text-[48px] text-white tracking-[2px] mb-[14px] relative z-[1]">
                    {card.title}
                  </h3>
      ...
      <section className="bg-cream py-[100px] relative overflow-hidden">
        <div
          ...
          style={{ background: "linear-gradient(to right, hsl(var(--red)), hsl(var(--gold)), hsl(var(--red)))" }}
        />
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-bebas text-[300px] text-navy/[0.03] tracking-[-10px] leading-none pointer-events-none whitespace-nowrap">
          FTF
        </div>
        ...
        <div className="max-w-[1200px] mx-auto px-[60px] max-md:px-6">
          <FadeUp>
            ...
            <h2
              className="font-bebas text-navy leading-none tracking-[1px] mb-5 text-center"
              style={{ fontSize: "clamp(40px, 5vw, 62px)" }}
            >
              Meet the Founder.
            </h2>
            <p className="text-[17px] leading-[1.8] text-[#555] font-light max-w-[620px] mt-[14px] text-center mx-auto">
              Fuel Their Future was built by a 14-year-old who saw a gap no one was closing — and decided to close it
              himself.
            </p>
          </FadeUp>
          <FadeUp>
              ...
              >
                ...
                <div className="w-full aspect-[4/5] overflow-hidden bg-navy">
                  <img
                    src={lennonImg}
                    alt="Lennon Fells"
                    className="w-full h-full object-cover object-top transition-transform duration-400 hover:scale-[1.04]"
                    style={{ filter: "grayscale(10%)" }}
                  />
                </div>
                <div className="p-7 flex-1 flex flex-col">
                  <div className="font-oswald text-red text-[10px] tracking-[3px] uppercase font-medium mb-[6px]">
                    {lennon?.homepage_role_label || "Founder & Visionary"}
                  </div>
                  <div className="font-bebas text-[34px] text-navy tracking-[1px] leading-none mb-3">
                    {lennon?.name || "Lennon Fells"}
                  </div>
          ...
          <FadeUp>
            <div className="grid grid-cols-3 gap-6 mt-[60px] max-md:grid-cols-1">
              {[
                {
                  icon: "🏫",
                  title: "School Assemblies & K–12 Events",
                  num: "01",
                  ...
                  topics: [
                    "Focus, Trust, Finish — the student-athlete mindset",
                    "Why nutrition is your #1 performance tool",
                ...
                {
                  icon: "🏈",
                  title: "Sports Teams & Athletic Organizations",
                  num: "02",
                  ...
                  topics: [
                    ...
                    "Elite nutrition for performance",
                    "Mental preparation and pressure management",
                    "The path from youth sports to the pros",
                  ],
                },
                {
                  icon: "🏢",
                  title: "Corporate Keynotes & Leadership Events",
                  num: "03",
                  ...
                  topics: [
                    "Building a winning culture — the NFL playbook",
                    "Accountability and execution under pressure",
                    "Purpose-driven leadership",
                    "Fuel to Win — performance and equity",
                  ],
                },
              ].map((card) => (
                <div
                  key={card.num}
                  className="border border-white/[0.09] p-[44px_34px] relative overflow-hidden bg-white/[0.02] transition-all duration-300 hover:border-red hover:-translate-y-[6px] hover:bg-red/[0.05] max-md:p-8"
                >
                  <div className="font-bebas text-[70px] text-white/[0.05] absolute top-[10px] right-4 leading-none">
                    {card.num}
                  </div>
                  <div className="w-[50px] h-[50px] bg-red flex items-center justify-center mb-6 text-[22px]">
                    {card.icon}
                  </div>
                  ...
                  <ul className="list-none mb-6">
                    {card.topics.map((t) => (
                      <li
                        key={t}
                        className="font-oswald text-white/45 text-[12px] py-[6px] border-b border-white/[0.06] flex gap-2"
                      >
                        <span className="text-red text-[10px] flex-shrink-0">—</span>
                        {t}
                      </li>
                    ))}
                  </ul>
      ...
      <section className="bg-navy-dark py-[100px] relative overflow-hidden">
        <div className="absolute left-0 top-0 bottom-0 w-2 bg-gradient-to-b from-red to-red-dark" />
        <div className="absolute -right-[60px] top-1/2 -translate-y-1/2 font-bebas text-[320px] text-white/[0.025] leading-none pointer-events-none tracking-[-10px]">
          #86
        </div>
          ...
          <FadeUp>
            <div className="grid grid-cols-1 md:grid-cols-[380px_1fr] gap-10 md:gap-[80px] items-center">
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-3 gap-[6px] mt-12">
                  <div className="aspect-[4/3] overflow-hidden">
                    <img
                      src={danielAction1}
                      alt="Daniel Fells NFL action"
                      className="w-full h-full object-cover grayscale-[20%] hover:grayscale-0 hover:scale-105 transition-all duration-400"
                    />
                  </div>
                  <div className="aspect-[4/3] overflow-hidden">
                    <img
              ...
              <div>
                ...
                <div
                  className="font-bebas text-white leading-[0.9] tracking-[1px] mb-2"
                  style={{ fontSize: "clamp(52px, 6vw, 80px)" }}
                >
                  {(daniel?.name || "Daniel Fells").split(" ")[0]}
                  <br />
                  {(daniel?.name || "Daniel Fells").split(" ").slice(1).join(" ")}
                </div>
                <div className="font-oswald text-red text-[13px] tracking-[3px] uppercase font-medium mb-7">
                  {daniel?.homepage_role_label ||
                ...
                {(
                  ...
                  .split("\n\n")
                  .map((p, i) => (
                    <p key={i} className="text-white/[0.68] text-[16px] leading-[1.9] font-light mb-4">
                      {p}
                    </p>
                  ))}
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-[2px] mb-8">
                  ...
                  <div className="bg-white/[0.05] p-[16px_12px] text-center border-t-[3px] border-gold">
                    ...
                    <div className="font-oswald text-white/50 text-[10px] tracking-[1px] uppercase mt-1 font-light">
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-[60px] relative z-[1]">
          {[
            ...
            <FadeUp key={stat.num} className="text-center">
              ...
              <div className="font-oswald text-white/[0.78] text-[13px] tracking-[2px] uppercase font-light mt-3 max-w-[200px] mx-auto leading-[1.5]">
                {stat.label}
              </div>
            </FadeUp>
          ))}
      ...
      <section id="partners" className="bg-white py-[100px]">
        <div className="max-w-[1200px] mx-auto px-[60px] max-md:px-6">
          <FadeUp>
            ...
            <h2
              className="font-bebas text-navy leading-none tracking-[1px] mb-5"
              style={{ fontSize: "clamp(40px, 5vw, 62px)" }}
            >
              Let's Build
              <br />
            ...
            <p className="text-[17px] leading-[1.8] text-[#555] font-light max-w-[600px] mt-[14px]">
              We're seeking mission-aligned partners who believe every child deserves the fuel to compete, learn, and
              thrive.
            </p>
          </FadeUp>
          <FadeUp>
              ...
              {[
                {
                  ...
                  body: "Bring Daniel Fells to your students for assemblies and athlete development events. We partner with district administrators to create lasting impact at scale.",
                },
                {
                  icon: "🤝",
                  title: "Corporate Sponsors",
                  body: "Align your brand with a movement connecting athletic excellence to social equity. Sponsorship opportunities for speaking tours, community events, and youth programming.",
                },
                {
                  icon: "🌎",
                  title: "Community Organizations",
                  body: "Partner with us to expand food access for children in your community. That community-first spirit drives every partnership we pursue.",
                },
                {
                  icon: "🏟️",
                  title: "Sports Organizations",
                  body: "Youth leagues, college programs, and professional teams — bring NFL-level perspective and a purpose-driven mission to your athletes, coaches, and staff.",
                },
                {
                  icon: "🥗",
                  title: "Food & Nutrition Brands",
                  body: "Connect your products to a message that resonates. Fuel Their Future bridges elite athletic nutrition and food equity advocacy in a unique and powerful way.",
                },
                {
                  icon: "📱",
                  title: "Media & Content Partners",
                  body: "Daniel Fells has a story worth telling — 10 NFL seasons, a family-built mission, and a message that changes lives. We welcome media and podcast collaboration.",
                },
              ].map((card) => (
                <div
                  key={card.title}
                  className="bg-gray-light border-t-4 border-navy p-[36px_28px] transition-all duration-200 hover:border-red hover:-translate-y-1 hover:shadow-[0_16px_40px_rgba(0,0,0,0.09)]"
                >
          ...
          <FadeUp>
            <div className="bg-navy p-[52px] flex justify-between items-center gap-10 flex-wrap max-md:p-6 max-md:flex-col">
              <div>
                <h3 className="font-bebas text-[36px] text-white tracking-[1px] mb-2">
                  Become a Fuel Their Future Partner
                </h3>
        ...
        <div className="max-w-[1200px] mx-auto px-[60px] grid grid-cols-2 gap-20 items-start max-md:grid-cols-1 max-md:px-6">
          <FadeUp>
            ...
            <p className="text-white/[0.62] text-[16px] leading-[1.8] font-light max-w-[460px] mt-4">
              Whether you're a school district, a sports organization, a corporation, or a community partner — we're
            ...
            <div className="flex flex-col gap-[14px] mt-8">
              {[
                ...
                <div key={d.text} className="flex items-center gap-[14px] font-oswald text-white/[0.78] text-[14px]">
                  <div className="w-[38px] h-[38px] bg-red flex items-center justify-center text-[15px] flex-shrink-0">
                    {d.icon}
                  </div>
                  {d.text}
                </div>
            ...
            {submitted ? (
              <div className="bg-white/[0.05] border border-white/10 p-10 text-center">
                ...
                <button
                  ...
                  className="mt-6 font-oswald text-red text-[12px] tracking-[2px] uppercase font-semibold bg-transparent border-none cursor-pointer hover:text-gold transition-colors"
                >
              ...
              <div className="flex flex-col gap-[14px]">
                <div className="grid grid-cols-2 gap-[14px] max-md:grid-cols-1">
                  ...
                  <div className="flex flex-col gap-[5px]">
                    <label className="font-oswald text-white/45 text-[10px] tracking-[2px] uppercase">
                      Organization
                    </label>
                    <input
                      placeholder="School, company, org"
                ...
                <div className="flex flex-col gap-[5px]">
                  ...
                  <textarea
                    ...
                    className="bg-white/[0.07] border border-white/[0.13] text-white px-4 py-[13px] text-[15px] outline-none focus:border-red transition-colors resize-y min-h-[110px] font-serif"
                    placeholder="Event details, audience size, date, and goals..."
                  />
                </div>
                <button
